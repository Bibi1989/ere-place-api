...
exports.createProduct = (req, res, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const [product] = yield pg_connect_1.db.query(pg_connect_1.sql `INSERT INTO products(title, category, category_type, description, price, location, image_url, stock, seller_id, age_to, age_from, size) VALUES(${title}, ${category}, ${category_type}, ${description}, ${price}, ${location}, ${image_url}, ${stock}, ${id}, ${age_to}, ${age_from}, ${size}) returning *`);
        return product;
    }
    catch (error) {
